! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).AlgoliaAnalytics = {})
}(this, function(e) {
    "use strict";
    var t = function() {
            try {
    ...
    var c = "insights-js (1.7.1)";
    var u = ["de", "us"],
        p = 2592e6;
    var h, f, l, d, w = function() {
    ...
    Object.keys || (Object.keys = (h = Object.prototype.hasOwnProperty, f = !{
        toString: null
    }.propertyIsEnumerable("toString"), d = (l = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"]).length, function(e) {
        ...
        if (f)
            for (r = 0; r < d; r++) h.call(e, l[r]) && n.push(l[r]);
        return n
    ...
    var g = function(e) {
            var r = e.requestFn;
            this._ua = "", this._uaURIEncoded = "", this.version = "1.7.1", this._hasCredentials = !1, this.sendEvent = function(e) {
                return function(t, r) {
                    if (!this._userHasOptedOut) {
                        ...
                        if (o(n)) throw new Error("Before calling any methods on the analytics, you first need to call 'setUserToken' function or include 'userToken' in the event payload.");
                        if (!i(r.index)) throw new TypeError("expected required parameter `index` to be a string");
                        if (!i(r.eventName)) throw new TypeError("expected required parameter `eventName` to be a string");
                        if (!o(r.userToken) && !i(r.userToken)) throw new TypeError("expected optional parameter `userToken` to be a string");
                        var a = {
                            eventType: t,
                        ...
                        if (!o(r.timestamp)) {
                            if (!s(r.timestamp)) throw new TypeError("expected optional parameter `timestamp` to be a number");
                            a.timestamp = r.timestamp
                        }
                        if (!o(r.queryID)) {
                            if (!i(r.queryID)) throw new TypeError("expected optional parameter `queryID` to be a string");
                            a.queryID = r.queryID
                        }
                        if (!o(r.objectIDs)) {
                        ...
                        if (!o(r.positions)) {
                            ...
                            if (o(r.objectIDs)) throw new Error("cannot use `positions` without providing `objectIDs`");
                        ...
                        if (!o(r.filters)) {
                            if (!o(r.objectIDs)) throw new Error("cannot use `objectIDs` and `filters` for the same event");
                            if (!Array.isArray(r.filters)) throw new TypeError("expected optional parameter `filters` to be an array");
                            a.filters = r.filters
                        }
                        if (o(r.objectIDs) && o(r.filters)) throw new Error("expected either `objectIDs` or `filters` to be provided");
            ...
            }(r).bind(this), this.init = function(e) {
                var t;
                if (!e) throw new Error("Init function should be called with an object argument containing your apiKey and appId");
                if (o(e.apiKey) || !i(e.apiKey)) throw new Error("apiKey is missing, please provide it so we can authenticate the application");
                if (o(e.appId) || !i(e.appId)) throw new Error("appId is missing, please provide it, so we can properly attribute data to your application");
                if (!o(e.region) && -1 === u.indexOf(e.region)) throw new Error("optional region is incorrect, please provide either one of: " + u.join(", ") + ".");
                if (!(o(e.cookieDuration) || s(e.cookieDuration) && isFinite(e.cookieDuration) && Math.floor(e.cookieDuration) === e.cookieDuration)) throw new Error("optional cookieDuration is incorrect, expected an integer.");
                this._apiKey = e.apiKey, this._appId = e.appId, this._userHasOptedOut = !!e.userHasOptedOut, this._region = e.region, this._endpointOrigin = e.region ? "https://insights." + e.region + ".algolia.io" : "https://insights.algolia.io", this._useCookie = null === (t = e.useCookie) || void 0 === t || t, this._cookieDuration = e.cookieDuration ? e.cookieDuration : 6 * p, this._hasCredentials = !0, this._ua = c, this._uaURIEncoded = encodeURIComponent(c), e.userToken ? this.setUserToken(e.userToken) : !this._userHasOptedOut && this._useCookie && this.setAnonymousUserToken()
                ...
                this._userToken = e, a(this._onUserTokenChangeCallback) && this._onUserTokenChangeCallback(this._userToken)
            }.bind(this), this.setAnonymousUserToken = function() {
                if (t()) {
                    var e = v(b);
                    e && "" !== e && 0 === e.indexOf("anonymous-") ? this.setUserToken(e) : (this.setUserToken("anonymous-" + w()), y(b, this._userToken, this._cookieDuration))
                }
                ...
                this._onUserTokenChangeCallback = e, t && t.immediate && a(this._onUserTokenChangeCallback) && this._onUserTokenChangeCallback(this._userToken)
            }.bind(this), this.clickedObjectIDsAfterSearch = function(e) {
                ...
                this.sendEvent("click", e)
            }.bind(this), this.convertedObjectIDsAfterSearch = function(e) {
                ...
                this.sendEvent("conversion", e)
            }.bind(this), this.viewedObjectIDs = function(e) {
            ...
            }.bind(this), this.viewedFilters = function(e) {
                ...
                this.sendEvent("view", e)
            }.bind(this), this._get = function(e, t) {
                t(this[e])
            }.bind(this)
        },
        I = function(e, t) {
    ...
    function k(e) {
        var t, r = e.AlgoliaAnalyticsObject;
        if (r) {
            var n = (t = this, function(e) {
                    for (var r = [], n = arguments.length - 1; n-- > 0;) r[n] = arguments[n + 1];
                    e && a(t[e]) ? t[e].apply(t, r) : console.warn("The method `" + e + "` doesn't exist.")
                }),
                o = e[r];
            o.queue = o.queue || [];
            var i = o.queue;
    ...
    function D(e) {
        ...
        return "undefined" != typeof window && k.call(t, window), t
    }
    var E = D(function() {
        if (r()) return I;
        if (n()) return m;
    ...
    e.createInsightsClient = D, e.default = E, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});